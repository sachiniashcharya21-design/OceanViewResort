...
<head>
    ...
    <title>Book Room - Ocean View Resort Admin</title>
...
<body>
    ...
    <div class="header">
        ...
        <div class="header-actions">
            <a href="<%= request.getContextPath() %>/admin/admin-customers.jsp" class="btn btn-back"><i class="fas fa-arrow-left"></i> Back to Customers</a>
            <a href="<%= request.getContextPath() %>/admin/admin-dashboard.jsp" class="btn btn-back"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
        </div>
    </div>
    ...
    <div class="main-content">
        ...
        <div class="filter-section">
            ...
            <form method="GET" action="<%= request.getContextPath() %>/admin/admin-book-room.jsp" class="filter-form">
                ...
                <div class="filter-buttons">
                    ...
                    <a href="<%= request.getContextPath() %>/admin/admin-book-room.jsp?guestId=<%= guestId %>&guestName=<%= URLEncoder.encode(guestName, "UTF-8") %>" class="btn btn-clear"><i class="fas fa-times"></i> Clear</a>
                </div>
            </form>
        </div>
    ...
    <div id="bookingModal" class="modal-overlay">
        <div class="modal-content">
            ...
            <form method="POST" action="<%= request.getContextPath() %>/admin/admin-book-room.jsp?guestId=<%= guestId %>&guestName=<%= URLEncoder.encode(guestName, "UTF-8") %>">
    ...
    <script>
        ...
        <% if (successMessage != null && newReservationId > 0) { %>
            Swal.fire({
                ...
                window.location.href = '<%= request.getContextPath() %>/admin/admin-payment.jsp?reservationId=<%= newReservationId %>';
            });
        <% } %>
