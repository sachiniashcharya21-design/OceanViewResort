...
<%
    ...
    // Statistics
    int totalReservations = 0, totalGuests = 0, totalRooms = 0, totalStaff = 0;
    ...
    try {
        ...
        if ("uploadProfilePic".equals(action) && "POST".equalsIgnoreCase(request.getMethod())) {
            ...
            try {
                ...
                if (uploadDir == null || uploadDir.trim().isEmpty()) {
                    ...
                    uploadDir = System.getProperty("catalina.base") + File.separator + "webapps" + File.separator
                        + contextName + File.separator + "uploads" + File.separator + "profiles";
                }
                ...
                PreparedStatement psUpload = conn.prepareStatement("UPDATE users SET profile_picture = ? WHERE user_id = ?");
                psUpload.setString(1, newFileName);
                psUpload.setInt(2, userId);
                psUpload.executeUpdate();
                psUpload.close();

                String imagePath = request.getContextPath() + "/uploads/profiles/" + newFileName;
                out.print("{\"success\": true, \"imagePath\": \"" + jsonEscape(imagePath) + "\"}");
            } catch (Exception ex) {
        ...
        if ("changePassword".equals(action) && "POST".equalsIgnoreCase(request.getMethod())) {
            ...
            // Verify current password using Java SHA-256
            PreparedStatement verifyPs = conn.prepareStatement("SELECT password, password_hash FROM users WHERE user_id = ?");
            ...
            if (verifyRs.next()) {
                ...
                try {
                    storedHash = verifyRs.getString("password_hash");
                } catch (SQLException ignored) {}

                String currentHash = sha256Hex(currentPassword);
                boolean currentOk = false;
                if (storedPassword != null && !storedPassword.isEmpty() && storedPassword.equals(currentPassword)) currentOk = true;
                if (storedHash != null && !storedHash.isEmpty() && (storedHash.equals(currentPassword) || storedHash.equals(currentHash))) currentOk = true;
                if (storedPassword != null && !storedPassword.isEmpty() && currentHash != null && storedPassword.equals(currentHash)) currentOk = true;
...
<head>
    ...
    <title>My Profile - Ocean View Resort Admin</title>
    ...
    <div class="main-content">
        ...
        <div class="profile-grid">
            ...
            <div class="profile-card">
                ...
                <div class="profile-role"><i class="fas fa-shield-alt"></i> Administrator</div>
                <br>
            ...
            <div class="details-section">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="${pageContext.request.contextPath}/admin/admin-profile.jsp">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="${pageContext.request.contextPath}/admin/admin-profile.jsp" id="passwordForm">
    ...
    <script>
        ...
        function uploadProfilePic(input) {
            if (input.files && input.files[0]) {
                ...
                prepareImageData(file).then(function(imageData) {
                    const payload =
                        'action=' + encodeURIComponent('uploadProfilePic') +
                        '&imageData=' + encodeURIComponent(imageData) +
                        '&fileName=' + encodeURIComponent(file.name || 'profile.jpg');
                    ...
                    xhr.open('POST', '${pageContext.request.contextPath}/admin/admin-profile.jsp', true);
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Upload Failed',
                        text: 'Could not process selected image.',
                        confirmButtonColor: '#008080'
                    });
                });
            }
        ...
        function prepareImageData(file) {
            return new Promise(function(resolve, reject) {
                ...
                reader.onload = function(e) {
                    ...
                    img.onload = function() {
                        ...
                        while (out.length > 1400000 && quality > 0.5) {
                            quality -= 0.1;
