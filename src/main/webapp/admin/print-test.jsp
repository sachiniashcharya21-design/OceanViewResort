...
<body>
    <div class="no-print">
        <a href="print-test.jsp?period=daily" class="btn btn-period <%= "daily".equals(period) ? "active" : "" %>">Daily</a>
        <a href="print-test.jsp?period=weekly" class="btn btn-period <%= "weekly".equals(period) ? "active" : "" %>">Weekly</a>
        <a href="print-test.jsp?period=monthly" class="btn btn-period <%= "monthly".equals(period) ? "active" : "" %>">Monthly</a>
