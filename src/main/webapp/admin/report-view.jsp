...
<%
    ...
    String dashboardLink = "ADMIN".equalsIgnoreCase(userRole) ? "admin-dashboard.jsp" : "../staff/staff-dashboard.jsp";
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-period { background: #f0f0f0; color: #333; }
        .btn-period.active { background: linear-gradient(135deg, #004040, #008080); color: white; }
...
<body>
    <div class="no-print">
        <a href="report-view.jsp?period=daily" class="btn btn-period <%= "daily".equals(period) ? "active" : "" %>">Daily</a>
        <a href="report-view.jsp?period=weekly" class="btn btn-period <%= "weekly".equals(period) ? "active" : "" %>">Weekly</a>
        <a href="report-view.jsp?period=monthly" class="btn btn-period <%= "monthly".equals(period) ? "active" : "" %>">Monthly</a>
    ...
    <div class="report-container">
        <div class="report-header">
            ...
            <p>Generated: <%= new SimpleDateFormat("MMMM dd, yyyy hh:mm a").format(new Date()) %></p>
        </div>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <%
                            ...
                            out.println("<tr><td colspan='5'>Database connection not available</td></tr>");
                        }
                    %>
                </tbody>
            </table>
        ...
        <div class="footer">
            ...
            <p>&copy; <%= new SimpleDateFormat("yyyy").format(new Date()) %> Ocean View Resort, Galle, Sri Lanka</p>
        </div>
    </div>
