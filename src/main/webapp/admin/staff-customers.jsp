...
<body>
    ...
    <main class="main-content">
        ...
        <div class="register-card">
            ...
            <form method="POST" action="staff-customers.jsp?action=addCustomer" id="registerForm">
                ...
                <table class="data-table" id="customerTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-nationality"><%= nationality %></span></td>
                            ...
                            <td>
                                <button class="action-btn view" title="View Details" 
                                    data-id="<%= guestId %>" 
                                    data-name="<%= fullName %>" 
                                    data-nic="<%= nicPassport != null ? nicPassport : "" %>" 
                                    data-email="<%= email != null ? email : "" %>" 
                                    data-phone="<%= phone != null ? phone : "" %>" 
                                    data-nationality="<%= nationality != null ? nationality : "" %>" 
                                ...
                                <button class="action-btn delete" title="Delete Customer" data-id="<%= guestId %>" data-name="<%= fullName %>" onclick="deleteCustomerData(this)"><i class="fas fa-trash"></i> Delete</button>
                                <a href="staff-book-room.jsp?guestId=<%= guestId %>&guestName=<%= java.net.URLEncoder.encode(fullName, "UTF-8") %>" class="action-btn book" title="Book Room"><i class="fas fa-calendar-plus"></i> Book</a>
                            </td>
                        </tr>
                        <%
                                }
    ...
    <div class="modal-overlay" id="editModal">
        <div class="modal">
            ...
            <form method="POST" action="staff-customers.jsp?action=editCustomer">
                <div class="modal-body">
        ...
        function deleteCustomer(id, name) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'staff-customers.jsp?action=deleteCustomer&guestId=' + id;
                }
            });
        }
