...
<%
    ...
    try {
        ...
        if (billId == 0) {
            response.sendRedirect("staff-customers.jsp?error=Invoice+not+found");
            return;
        }
    } catch (Exception e) {
    ...
    try {
        ...
        if (rs.next()) {
            ...
            response.sendRedirect("staff-customers.jsp?error=Bill+not+found");
            return;
        }
        rs.close();
        ps.close();
...
<body>
    ...
    <div class="no-print">
        ...
        <a href="staff-customers.jsp" class="btn btn-secondary">
