...
<%
    ...
    try {
        ...
        if (billId == 0) {
            response.sendRedirect(contextPath + "/staff/staff-invoices.jsp?error=Invoice+not+found");
            return;
        }
    } catch (Exception e) {
        response.sendRedirect(contextPath + "/staff/staff-invoices.jsp");
        return;
    }
...
<body>
    ...
    <div class="no-print">
        ...
        <a href="<%= contextPath %>/staff/staff-invoices.jsp" class="btn btn-secondary">
            <i class="fas fa-arrow-left"></i> Back to Invoices
        </a>
        <a href="<%= contextPath %>/staff/staff-dashboard.jsp" class="btn btn-secondary">
    ...
    <div class="invoice-container" id="invoice">
        ...
        <div class="invoice-header">
            <div class="logo-section">
                <img src="<%= contextPath %>/images/logo.png" alt="Ocean View Resort" class="logo-img">
                <div class="logo-text">
