...
<%
    ...
    try {
        ...
        response.sendRedirect(contextPath + "/staff/staff-customers.jsp");
        return;
    }
    ...
    try {
        ...
        if (rs.next()) {
            ...
            response.sendRedirect(contextPath + "/staff/staff-customers.jsp?error=Reservation+not+found");
            return;
        }
        rs.close();
        ps.close();
...
<head>
    ...
    <title>Process Payment - Ocean View Resort Staff</title>
...
<body>
    ...
    <header class="header">
        ...
        <div class="header-actions">
            <a href="staff-customers.jsp" class="btn btn-back">
    ...
    <main class="main-content">
        <% if ("PAID".equals(paymentStatus)) { 
            ...
            response.sendRedirect("staff-invoice.jsp?billId=" + billId);
            return;
        } else { %>
            <div class="payment-grid">
                ...
                <div>
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="staff-payment.jsp" method="post" id="paymentForm">
                                ...
                                <div style="display: flex; gap: 10px; margin-top: 25px;">
                                    <a href="staff-customers.jsp" class="btn btn-secondary" style="flex: 1; justify-content: center;">
